...
2.	Para el departamento de Pinturas:
    ...
    A.	Al ingresar una temperatura en Centígrados debemos mostrar la temperatura en Fahrenheit 
        (0 °C × 9/5) + 32 = 32 °F
    
    B.	Al ingresar una temperatura en Fahrenheit debemos mostrar la temperatura en Centígrados con un mensaje concatenado 
        (0 °F − 32) × 5/9 = -17,78 °C
'''
...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        conversion_f = (temperatura_c * 9/5) + 32
        
        alert(f"La temperatura en fahrenheints es: " , conversion_f)

    def btn_convertir_f_c_on_click(self):
         temperatura_f = float(self.txt_temperatura_f.get())

         conversion_c = (temperatura_f - 32) * (5/9)
        

         alert(f"La temperatura en centigrados es: " , conversion_c)
